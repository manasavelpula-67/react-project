...
function NonVeg() {
  const items = useSelector((state) => state.products.nonVeg);
  ...
  return (
    <div className="container mt-5 text-center m-5 p-5">
      <h1 className="mb-3 m-5 container text-success fst-italic">NonVeg Items</h1>
      <p className="lead">
        Here you can browse a variety of non-vegetarian items.
      </p>
